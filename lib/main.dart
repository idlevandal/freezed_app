...
final todoWithUsernameProvider = FutureProvider<List<Todo>>((ref) async {
...
final filteredTodosProvider = FutureProvider<List<Todo>>((ref) async {
  final todos = await ref.watch(todoWithUsernameProvider.future);
...
class Root extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final _todos = ref.watch(filteredTodosProvider);
    return Scaffold(
      appBar: AppBar(
        actions: [
          IconButton(
